export const SITE = {
  ...
  story: {
    ...
    paragraphs: [
      "O Abrigo Amigo Bicho nasceu de um gesto simples, e de uma dor que virou propósito. Em 2020, durante a pandemia, Maria Eduarda realizou seu primeiro resgate. Um cachorro apareceu na porta de sua casa e, por dias, permaneceu ali, como se pedisse ajuda.",
      "A intenção inicial era encontrar um lar para ele, mas ao longo dos cuidados, foi descoberto que ele estava doente. Para tentar salvá-lo, nasceu uma página no Instagram, criada com o objetivo de arrecadar doações para seu tratamento. Ele foi acolhido, recebeu cuidados, atenção e carinho… mas poucas semanas depois não resistiu.",
      "A perda foi muito difícil. Mas, junto com ela, ficou algo que mudaria tudo: ainda havia um pequeno valor das doações recebidas. E aí veio a decisão de usar aquele recurso para ajudar outro animal em necessidade. Assim, o que era um ato isolado se transformou em um propósito.",
      ...
      "Foi ali, de forma simples, improvisada, mas cheia de amor e responsabilidade, que o abrigo começou institucionalmente. Durante quatro anos, a laje foi refúgio, recomeço e lar para dezenas de cães que precisavam de uma segunda chance.",
      "Com o crescimento do projeto e a necessidade de oferecer ainda mais estrutura e qualidade de vida aos animais, o abrigo deu um novo passo: mudou-se para seu espaço atual, em Aldeia. Hoje, o Abrigo Amigo Bicho segue com o mesmo propósito que o originou: transformar dor em cuidado, abandono em acolhimento e histórias interrompidas em novos começos.",
    ],
    closingQuote: "Porque, desde o primeiro resgate, uma coisa nunca mudou: a certeza de que cada vida importa.",
    milestones: [
