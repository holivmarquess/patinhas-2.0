  ...
  adoptions: {
    ...
    animals: [
      ...
      },
      {
        ...
        gender: "Macho",
        size: "Grande",
        personality: ["Protetor", "Meigo"],
        shortDescription: "É um garotão, ama cuidar da área ao redor do abrigo.",
        story:
          "Foi resgatado ainda filhote junto com mais 2 irmãozinhos que já tiveram a sorte de serem adotados. É muito tranquilo, mas desconfiado. Pra conquistar ele precisa só de um tempinho e paciência",
        sinceWhen: "Setembro de 2022",
        care: {
          vaccinated: true,
          neutered: true,
          dewormed: true,
      ...
      },
      {
        ...
        gender: "Macho",
        size: "Pequeno",
        personality: ["xxx", "xxx", "Companheiro"],
        shortDescription: "Vítima de maus tratos, é desconfiado, porém muito.",
        story:
          "Foi resgatado amarrado com uma corda no pescoço, muito ferido, e preso próximo às fábricas do bairro do Curado. É um cachorrinho muito desconfiado e reativo. Não gosta de toques, o trauma ainda ronda ele.",
        sinceWhen: "Agosto de 2023",
        care: {
          vaccinated: true,
          neutered: true,
          dewormed: true,
      ...
      },
      {
        ...
        story:
          "Foi resgatada ainda filhote dentro de uma mata em aldeia junto com mais duas irmãzinhas. Chegou no abrigo cheia de medo. É uma cadela que precisa de muito carinho e  paciência, pois os traumas sofridos no passado ainda assombram ela. É desconfiada mas rapidinho se conquista a confiança dela.",
        sinceWhen: "Outubro de 2020",
        care: {
          vaccinated: true,
          neutered: false,
          dewormed: true,
